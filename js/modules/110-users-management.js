...
let _userCache = null; 
    ...
    function refreshUserList(force = false) {
        ...
        tbody.innerHTML = '<tr><td colspan="6" class="p-12 text-center text-gray-400 italic"><div class="flex flex-col items-center"><i class="fas fa-circle-notch fa-spin text-2xl mb-3 text-amber-500"></i>Fetching user data...</div></td></tr>';
    ...
    function renderApprovalSection() {
        ...
        cont.innerHTML = pending.map(u => `
            <div class="bg-white border border-amber-200 rounded-2xl p-4 shadow-sm relative overflow-hidden group">
                ...
                <div class="flex gap-3 mb-3">
                    <div class="w-10 h-10 rounded-full bg-gradient-to-br from-amber-400 to-orange-500 text-white flex items-center justify-center font-bold text-sm shrink-0 shadow-md">
                ...
                <div class="flex gap-2">
                    <button onclick="handleApprove('${u.id}', ${u.rowIndex})" class="flex-1 bg-emerald-50 text-emerald-600 hover:bg-emerald-500 hover:text-white py-2 rounded-xl text-xs font-bold transition-all border border-emerald-100 hover:border-emerald-500">
    ...
    function filterUserTable() {
        ...
        tbody.innerHTML = filtered.map((u, i) => {
            ...
            else if(u.role === 'STAFF') roleColor = 'emerald';
            ...
            <tr class="hover:bg-gray-50 transition-colors">
                ...
                <td class="p-4 border-r text-center">
                    <span class="text-green-500 text-xs font-bold"><i class="fas fa-circle text-[8px] mr-1"></i> Active</span>
                </td>
